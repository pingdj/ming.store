...
const translations = {
    'zh': {
        ...
        cl_v4_desc: '集成 DeepSeek 大模型，自动分析交易意图、风险评分并生成操作建议，同时支持幽默评语，让冰冷的链上数据“开口说话”。',
        ...
        cl_v10_title: '✨ 旗舰进化 · 悬浮窗 & 土狗雷达 & Web3 AI 助手',
        cl_v10_desc: '新增桌面悬浮窗实时滚动通知；集成 GeckoTerminal 链上土狗雷达，监控新币对并支持 AI 解读；内置 Web3 AI 聊天助手，支持联网搜索与多会话管理。',
        // AI 模块
