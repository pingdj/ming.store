...
const translations = {
    'zh': {
        ...
        hero_desc: 'EVM + Solana 双链实时追踪，AI 解读交易与风险，RootData 新项目推送，GeckoTerminal 链上新币雷达，CryptoRank、CMC  项目跟踪，Web3 AI 助手。为专业交易者打造的一站式链上哨兵。',
        ...
        // 版本亮点（V1-V10）
        changelog_title: '📌 版本亮点 · 从 V1 到 V10 的进化之路',
        ...
        cl_v4_desc: '集成 DeepSeek和Moonshot 大模型，自动分析交易意图、风险评分并生成操作建议，同时支持幽默评语，让冰冷的链上数据“开口说话”。',
        ...
        cl_v8_desc: '自动抓取 RootData 最新融资项目，第一时间推送项目名称、融资额、社交信息，帮助用户抢占一级市场先机。',
        ...
        screenshot1: '实时仪表盘 · 多链状态总览', screenshot2: 'CMC新币实时监控', screenshot3: '链上雷达实时监控',
    ...
    'en': {
        ...
        // 版本亮点（V1-V10 英文翻译）
        changelog_title: '📌 Release Highlights · Evolution from V1 to V10',
        ...
        cl_v8_desc: 'Automatically fetches the latest funded projects from RootData, pushing project names, funding amounts, and social links in real time, helping users seize primary market opportunities.',
        ...
        cl_v10_desc: 'Added desktop floating widget for real-time scrolling notifications; integrated GeckoTerminal on-chain scanner for new pairs with AI interpretation; built-in Web3 AI chatbot supporting web search and multi-session management.',
        // AI 模块
